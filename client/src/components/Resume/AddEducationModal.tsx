...
const AddEducationModal = ({modalOpen , setModalOpen}:IProp) => {
        ...
        <div className="modal_work flex justify-center text-black ">
            <div className="modal_work-content !w-1/2">
                <div className="modal_work-header">
                    <h3 className="modal_work-title">Добавить место учебы</h3>
                </div>
                ...
                <form action="">
                    ...
                    <div className="form_group">
                        <label className="form_label" htmlFor="input-email">Введите место учебы</label>
                        <input className="form_input" name="input-email" type="text" id="input-email" placeholder="место"/>
                    </div>


                    <div className="form_group">
                        <label className="form_label" htmlFor="input-email">Введите года учебы</label>
