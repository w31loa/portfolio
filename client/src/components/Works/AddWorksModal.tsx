...
const AddWorksModal = ({modalOpen , setModalOpen}:IProp) => {
        ...
        <div className="modal_work flex justify-center text-black ">
            <div className="modal_work-content !w-1/2">
                <div className="modal_work-header">
                    <h3 className="modal_work-title">Добавить работу</h3>
                </div>

                <form action="">
                    <div className="form_group">
                        <label className="form_label" htmlFor="input-email">Введите название проекта</label>
                        <input className="form_input" name="input-email" type="text" id="input-email" placeholder="Название проекта"/>
                    </div>


                    <div className="form_group">
                        <label className="form_label" htmlFor="input-email">Выберите категорию</label>
                        {/* <input className="form_input" name="input-email" type="text" id="input-email" placeholder="Название компании"/> */}
                        <select name="" className="form_input text-black " id="">
                            <option value="1">Программа</option>
                            <option value="2">Веб-сайт</option>
                            <option value="3">Интерактив</option>
                        </select>
                    </div>

                    <div className="form_group">
                        <label className="form_label" htmlFor="input-email">Введите клиента</label>
                        <input className="form_input" name="input-email" type="text" id="input-email" placeholder="Название компании"/>
                    </div>
                    
                    <div className="form_group">
                        <label className="form_label" htmlFor="input-email">Введите год</label>
       
                        <input className="form_input " name="input-email" type="number" id="input-email" placeholder="Год"/>
